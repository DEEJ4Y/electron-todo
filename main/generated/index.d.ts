...
export namespace Prisma {
  ...
  */
  ...
  export type TodoListOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title", ExtArgs["result"]["todoList"]>
  ...
  export type TodoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "checked" | "listId", ExtArgs["result"]["todo"]>
  ...
  export interface Prisma__TodoClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    list<T extends TodoListDefaultArgs<ExtArgs> = {}>(args?: Subset<T, TodoListDefaultArgs<ExtArgs>>): Prisma__TodoListClient<$Result.GetResult<Prisma.$TodoListPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface TodoFieldRefs {
    ...
    readonly checked: FieldRef<"Todo", 'Boolean'>
    readonly listId: FieldRef<"Todo", 'Int'>
  }
  ...
  export type TodoWhereInput = {
    ...
    checked?: BoolFilter<"Todo"> | boolean
    listId?: IntFilter<"Todo"> | number
    list?: XOR<TodoListScalarRelationFilter, TodoListWhereInput>
  }
  ...
  export type TodoScalarWhereWithAggregatesInput = {
    ...
    checked?: BoolWithAggregatesFilter<"Todo"> | boolean
    listId?: IntWithAggregatesFilter<"Todo"> | number
  }
